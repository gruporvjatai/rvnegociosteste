// =============================================
//   RV NEGÓCIOS - js/usuarios.js
//   CRUD de Usuários (acesso admin)
// =============================================
    ...
    document.getElementById('users-list').innerHTML = STATE.users.map(u => `
        <tr class="border-b hover:bg-slate-50">
            ...
            <td class="p-4 text-center">
                <span class="px-2 py-1 rounded text-[10px] font-bold ${u.ativo ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}">
                    ${u.ativo ? 'ATIVO' : 'INATIVO'}
                </span>
            </td>
            <td class="p-4 text-center">
                <button onclick="openUserForm('${u.id}')" class="text-blue-600 hover:text-blue-800">
...
async function saveUser(e) {
    ...
    if (error) { showLoading(false); return showToast("Erro ao salvar usuário: " + error.message, true); }
