    ...
    <tr class="border-b hover:bg-slate-50 transition">
        ...
        <td class="p-4 text-center">
            <div class="flex items-center justify-center gap-2">
                <button onclick="openProductHistory('${p.nome.replace(/'/g, "\\'")}')" class="p-2 border border-indigo-200 text-indigo-600 hover:bg-indigo-50 rounded bg-indigo-50/50" title="Ver Histórico de Compras e Preços">
